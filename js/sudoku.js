	...
	var methods = {
			...
			return $(this).each(function(){
				...
				if (status == true)
				{
					...
					editableCells.keydown(function(event){
					    ...
					    $(this).parent().data('val', String.fromCharCode(charCode));

					    // onChange Trigger
						if ($.isFunction( args[1] ))
							args[1].call( this );

						var incomplete = editableCells.length;
	    ...
	    init : function( options ) {
		    ...
		    return this.each(function() {
				...
				/* Editable
				------------------------------------*/
				methods.editable.call(this, [settings.editable, settings.onChange, settings.onComplete, settings.onFill]);
